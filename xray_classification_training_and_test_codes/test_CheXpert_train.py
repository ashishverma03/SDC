...
args.datapath = '../data/CheXpert-MIMIC'
args.Classify_only = True
savepath = './trained_models/'
args.model = 'R18'
test_txt_file = args.datapath+'/images/train.txt'
test_image_path = args.datapath+'/images/train_pad_pt/'
result_savepath = 'CheXpert_train.txt'
...
np.save(savepath+'GT_CheXpert_test.npy', GT)
np.save(savepath+'PRED_CheXpert_test.npy', PRED)
np.save(savepath+'UN_CheXpert_test.npy', UN)
