...
parser.add_argument('--datapath', default='/home1/ChestXray/data/MIMIC-CXR-JPG', type=str, help='NIH xray images data')
...
parser.add_argument('--ClassifyScan_only', action='store_true', help='')
...
#if args.valid_only:
	#args.trained_model = '../MIT_Save_scan/'+args.exp_name+'/'+args.model+'_ID_'+str(args.split_id)+'_best.pth.tar'
