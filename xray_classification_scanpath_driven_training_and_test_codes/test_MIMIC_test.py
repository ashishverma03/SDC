...
args.datapath = '/home1/ChestXray/data/MIMIC-JPG'
...
test_txt_file = '/home1/ChestXray/data/MIMIC-JPG/images/test.txt'
...
path_captions = '/home1/ChestXray/LSTM/LSTM_REFLACX/MIMIC-JPG/test_pad_scan/'
...
np.save(savepath+expname+'/GT_MIMIC_test.npy', GT)
np.save(savepath+expname+'/PRED_MIMIC_test.npy', PRED)
np.save(savepath+expname+'/UN_MIMIC_test.npy', UN)
